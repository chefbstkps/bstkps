-- Voeg paginazichtbaarheid 'phone_numbers' toe aan user_page_visibility.
-- Voer uit in Supabase SQL Editor na add-phone-numbers-table.sql.

-- 1. Constraint aanpassen zodat 'phone_numbers' is toegestaan
...
-- 2. Functie get_user_page_visibility bijwerken (phone_numbers in de lijst)
--    phone_numbers: standaard altijd zichtbaar (true) tenzij expliciet uit gezet
